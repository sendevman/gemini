...
export const STUDENT_ADDRESS_START = "STUDENT_ADDRESS_START";
export const STUDENT_ADDRESS_END = "STUDENT_ADDRESS_END";


export let blockUIActions = [REGISTER_START, AUTHENTICATING, STUDENT_SEARCH_START, STUDENT_CREATE_PRE_ENROLLMENT_START];
export let unblockUIActions = [REGISTER_END, AUTHENTICATED, STUDENT_SEARCH_END, STUDENT_CREATE_PRE_ENROLLMENT_END];
