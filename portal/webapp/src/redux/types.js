...
//todo: fran verify if a regex can be use in ReduxBlockUI
export let blockUIActions = [
    ...
    , SESSION_CHECK_START
    , HOME_LOAD_START
    , STUDENT_PERSONAL_INFO_LOAD_START
    , VOCATIONAL_PRE_ENROLLMENT_SUBMIT_START];
...
export let unblockUIActions = [
    ...
    , SESSION_CHECK_END
    , HOME_LOAD_END
    , STUDENT_PERSONAL_INFO_LOAD_END
    , VOCATIONAL_PRE_ENROLLMENT_SUBMIT_END];
